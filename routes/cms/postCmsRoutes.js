...
module.exports = function (app) {
    ...
    app.post('/burning/cms/createPost',loginFilter,function(req,res){
        ...
        var post = new Post(dbUtil.getObjectId(dbUtil.getNewId()),dbUtil.getObjectId(_post.appId),dbUtil.getObjectId(_post.categoryId),dbUtil.getObjectId(_post.boardId),_post.title,null,null,_post.urlPromotion,null);
